...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => esc_html__( 'Theme Options', 'business-buzz' ),
	'priority'   => 100,
...
$wp_customize->add_section( 'section_header',
	array(
	'title'      => esc_html__( 'Header Options', 'business-buzz' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
...
$wp_customize->add_control( 'theme_options[show_title]',
	array(
	'label'    => esc_html__( 'Show Site Title', 'business-buzz' ),
...
$wp_customize->add_control( 'theme_options[show_tagline]',
	array(
	'label'    => esc_html__( 'Show Tagline', 'business-buzz' ),
	'section'  => 'section_header',
	'type'     => 'checkbox',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[contact_number]',
	array(
	'label'    => __( 'Contact Number', 'business-buzz' ),
	'section'  => 'section_header',
	'type'     => 'text',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[contact_email]',
	array(
	'label'    => __( 'Contact Email', 'business-buzz' ),
	'section'  => 'section_header',
	'type'     => 'text',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[show_social_in_header]',
	array(
		'label'    => __( 'Enable Social Icons', 'business-buzz' ),
		'section'  => 'section_header',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[show_search_in_header]',
	array(
		'label'    => esc_html__( 'Enable Search Form', 'business-buzz' ),
		'section'  => 'section_header',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_section( 'section_layout',
	array(
	'title'      => esc_html__( 'Layout Options', 'business-buzz' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[global_layout]',
	array(
	'label'    => esc_html__( 'Global Layout', 'business-buzz' ),
	'section'  => 'section_layout',
	'type'     => 'select',
	'choices'  => business_buzz_get_global_layout_options(),
	'priority' => 100,
	)
);
...
$wp_customize->add_control( 'theme_options[archive_layout]',
	array(
	'label'    => esc_html__( 'Archive Layout', 'business-buzz' ),
	'section'  => 'section_layout',
	'type'     => 'select',
	'choices'  => business_buzz_get_archive_layout_options(),
	'priority' => 100,
	)
);
...
$wp_customize->add_section( 'section_footer',
	array(
	'title'      => esc_html__( 'Footer Options', 'business-buzz' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => esc_html__( 'Copyright Text', 'business-buzz' ),
...
$wp_customize->add_section( 'section_blog',
	array(
	'title'      => esc_html__( 'Blog Options', 'business-buzz' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_setting( 'theme_options[excerpt_length]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'business_buzz_sanitize_positive_integer',
	)
);
$wp_customize->add_control( 'theme_options[excerpt_length]',
	array(
	'label'       => esc_html__( 'Excerpt Length', 'business-buzz' ),
	'description' => esc_html__( 'in words', 'business-buzz' ),
