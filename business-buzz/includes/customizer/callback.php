...
if ( ! function_exists( 'business_buzz_is_featured_slider_active' ) ) :
	 ...
	 */
	function business_buzz_is_featured_slider_active( $control ) {
...
if ( ! function_exists( 'business_buzz_is_featured_page_slider_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function business_buzz_is_featured_page_slider_active( $control ) {
