...
<div class="content-wrap">
	...
	<div class="entry-content">
		<?php $archive_layout = business_buzz_get_option( 'archive_layout' ); ?>

		<?php if ( 'full' === $archive_layout ) : ?>
			<?php
			the_content( sprintf(
				/* translators: %s: Name of current post. */
				wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'business-buzz' ), array( 'span' => array( 'class' => array() ) ) ),
